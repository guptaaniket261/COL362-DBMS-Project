...
\copy company_details from tables/company_details_latest.csv DELIMITER ',' CSV HEADER;
\copy job_details from tables/job_details.csv DELIMITER ',' CSV HEADER;
\copy user_details from tables/userDetailsLatest.csv DELIMITER ',' CSV HEADER;
\copy experiences from tables/experiencesNew.csv DELIMITER ',' CSV HEADER;
\copy login_details from tables/login_details.csv DELIMITER ',' CSV HEADER;
