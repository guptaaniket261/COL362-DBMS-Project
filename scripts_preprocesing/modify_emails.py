...
user_data = pd.read_csv('userDetailsNew.csv')
df = pd.DataFrame(user_data)
#print(exp_data)
#print(user_data)
fields = ["userId","firstname","lastname","age","gender","ethnicity","address","state","email","contact","Education"]
newDataset = []
for idx, row in user_data.iterrows():
  temp = row
  temp["email"] = row["firstname"]+str(row["userId"])+"@gmail.com"
  newDataset.append(temp)

with open('userDetailsLatest', 'w') as f:
